MEPH.define('MEPH.qrcode.Generator', {
    properties: {
        qrcodeGenerator: null
    },
    initialize: function () {
        var me = this;
        me.qrcodeGenerator = null;
    },
    setEl: function (el) {
        var me = this;
        me.element = el;
        if (me.qrcodeGenerator) me.qrcodeGenerator.setEl(el);
    },
    clear: function () {
        var me = this;
        if (me.qrcodeGenerator)
 ...
 */
    ...
    (function () {
        ...
        QRCode.prototype.setEl = function (el) {
            this._el = el;
        }
        /**
         * Make the QRCode
    ...
    MEPH.qrcode.Generator.$QRCode = QRCode;
})